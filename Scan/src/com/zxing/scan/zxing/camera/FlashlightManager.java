...
final class FlashlightManager {
	...
	private static Class<?> maybeForName(String name) {
		try {
			...
			LogUtils.w(TAG, "Unexpected error while finding class " + name
					+ "--" + re.getMessage());
			return null;
		}
	}
	...
	private static Method maybeGetMethod(Class<?> clazz, String name,
		...
		try {
			...
			LogUtils.w(TAG, "Unexpected error while finding method " + name
					+ "--" + re.getMessage());
			return null;
		}
	}
	...
	private static Object invoke(Method method, Object instance, Object... args) {
		try {
			...
			LogUtils.w(TAG, "Unexpected error while invoking " + method
					+ "--" + e.getMessage());
			return null;
