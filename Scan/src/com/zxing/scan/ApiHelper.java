...
public class ApiHelper {
    ...
    public static final boolean HAS_SET_VIEW_ROTATION =
    		Build.VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB
    		&& hasMethod(View.class, "setRotation", float.class);
    ...
    public static final boolean IS_BAD_SCORE_IN_FACE_DETECTION =
    ...
    public static boolean supportCameraHdr(Parameters params) {
    	if (null == params || !HAS_CAMERA_HDR) {
			return false;
		}
    	...
    	boolean support = list.contains(Parameters.SCENE_MODE_HDR);
    	LogUtils.d("Nodin", "This device support hdr: " + support);
    	return support;
    }
}